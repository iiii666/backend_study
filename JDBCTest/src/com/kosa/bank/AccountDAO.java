...
public class AccountDAO implements AccountDAOInterface {
	...
	public void accountInsert(AccountVO newAccount) {
		...
		try {
			...
			cs.setString(1, newAccount.getAno());
			cs.setString(2, newAccount.getOwner());
			cs.setDouble(3, newAccount.getBalance());
	...
	public boolean accountFindOne(String ano) {
		...
		try {
			...
			cs.setString(2, ano);
			cs.executeUpdate();
			String accountExist = cs.getString(1);
